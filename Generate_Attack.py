...
Forked from Jiefeng Chen: https://github.com/jfc43/robust-ood-detection

Generates adversarial examples that target the Mahalanobis score mechanism / regressor.
"""
